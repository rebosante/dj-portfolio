    ...
    <div class="max-w-4xl mx-auto">
      <div class="text-jayge-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-between items-center mb-4">
          <h3
            class="text-xl font-bold leading-none text-jayge-200 typewriter"
            v-typewriter
          >
            {{ $t("music.frame_title") }}
          </h3>
        ...
        <div class="flow-root max-h-72 overflow-y-auto scroll-aspect">
          <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
            <!-- Show loaders while data is being fetched -->
            <li v-if="loading" class="py-3 sm:py-4 flex items-center justify-center" v-for="n in 10" :key="n">
              <div role="status">
            ...
            <!-- Show music items once data is loaded -->
            <li
              v-else
              class="py-3 sm:py-4"
